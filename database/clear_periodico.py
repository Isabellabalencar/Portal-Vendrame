...
def main():
    parser = argparse.ArgumentParser(description="Limpa tabela solicitacoes_periodico e apaga pastas por protocolo.")
    parser.add_argument("--db", default="database/Users.db", help="Caminho do Users.db")
    parser.add_argument("--base-pastas", required=True, help="Base das pastas (ex: C:\\...\\Documentos_Periodico)")
